...
document.getElementById("7fDivclub7").innerHTML="G";document.getElementById("7fLogoclub7").innerHTML=logopalmeiras;document.getElementById("7fNomeclub7").innerHTML="Palmeiras";document.getElementById("7fgolj2club7").innerHTML="4";document.getElementById("7fgolj1club7").innerHTML="0";document.getElementById("7fNivelclub7").innerHTML="11";document.getElementById("7fTecclub7").innerHTML=tec7.nome;document.getElementById("7fDivclub8").innerHTML="C";document.getElementById("7fLogoclub8").innerHTML=logobragantino;document.getElementById("7fNomeclub8").innerHTML="Bragantino";document.getElementById("7fgolj1club8").innerHTML="3";document.getElementById("7fgolj2club8").innerHTML="4";document.getElementById("7fNivelclub8").innerHTML="8";document.getElementById("7fTecclub8").innerHTML=tec168.nome;
    ...
    document.getElementById("8fDivclub1").innerHTML="H";document.getElementById("8fLogoclub1").innerHTML=logolibertadpar;document.getElementById("8fNomeclub1").innerHTML="Libertad";document.getElementById("8fgolj2club1").innerHTML="";document.getElementById("8fgolj1club1").innerHTML="";document.getElementById("8fNivelclub1").innerHTML="1";document.getElementById("8fTecclub1").innerHTML=tec183.nome;document.getElementById("8fDivclub2").innerHTML="G";document.getElementById("8fLogoclub2").innerHTML=logodanubio;document.getElementById("8fNomeclub2").innerHTML="Danubio";document.getElementById("8fgolj1club2").innerHTML="";document.getElementById("8fgolj2club2").innerHTML="";document.getElementById("8fNivelclub2").innerHTML="4";document.getElementById("8fTecclub2").innerHTML=tec545.nome;
    document.getElementById("8fDivclub3").innerHTML="E";document.getElementById("8fLogoclub3").innerHTML=logofluminense;document.getElementById("8fNomeclub3").innerHTML="Fluminense";document.getElementById("8fgolj2club3").innerHTML="";document.getElementById("8fgolj1club3").innerHTML="";document.getElementById("8fNivelclub3").innerHTML="5";document.getElementById("8fTecclub3").innerHTML=tec87.nome;document.getElementById("8fDivclub4").innerHTML="C";document.getElementById("8fLogoclub4").innerHTML=logobragantino;document.getElementById("8fNomeclub4").innerHTML="Bragantino";document.getElementById("8fgolj1club4").innerHTML="";document.getElementById("8fgolj2club4").innerHTML="";document.getElementById("8fNivelclub4").innerHTML="8";document.getElementById("8fTecclub4").innerHTML=tec168.nome;
