...
let gremio=['Grêmio',logogremio,'Grande','RS','RS','A',1,'G8',0,1,3,0,1,3,5,4,2,2,4,2,3,2,0,0,3,5,0,3,5,3,3,1,0,4,3,0,0,1,5,0,0,3,3,4,3,4,'','','','','','','','','','','','','','','','','','','16','2023'];
...
document.getElementById("CardNomeTec1").innerHTML=Rodadas[rodada][16].nome;
  ...
  document.getElementById("CardAssumiu1").innerHTML="Assumiu o clube na "+Rodadas[rodada][187][64]+"ªrod. de "+Rodadas[rodada][187][65];
