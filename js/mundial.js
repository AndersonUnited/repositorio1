...
function toggleMenu() {
  ...
  let logotec574="<img src='https://s3.glbimg.com/v1/AUTH_58d78b787ec34892b5aaa0c7a146155f/cartola_svg_223/escudo/db/30/08/004997f2f7-be90-4d3b-95c0-00917a7f9cdb20240403113008' width='100%'>;"
...
let tec574={idCart:12008991,nome:'S.C. Cevadas Paulista',nomeLogin:'Thiago A. Wolfmann',nomePess:'opcional',anoEnt:2024,logo:logotec574,ClubAtual:kashimaantlers,titulo1:'',titulo2:'',titulo3:'',titulo4:'',titulo5:'',titulo6:'',titulo7:'',titulo8:'',titulo9:'',titulo10:'',titulo11:'',titulo12:'',titulo13:'',titulo14:'',titulo15:'',titulo16:'',titulo17:'',titulo18:'',titulo19:'',titulo20:''};
...
document.getElementById("6fDivclub1").innerHTML="";document.getElementById("6fLogoclub1").innerHTML=logopachuca;document.getElementById("6fNomeclub1").innerHTML="Pachuca";document.getElementById("6fgolj2club1").innerHTML="";document.getElementById("6fgolj1club1").innerHTML="";document.getElementById("6fNivelclub1").innerHTML="RC";document.getElementById("6fTecclub1").innerHTML=tec0.nome;document.getElementById("6fDivclub2").innerHTML="";document.getElementById("6fLogoclub2").innerHTML=logoatalanta;document.getElementById("6fNomeclub2").innerHTML="Atalanta";document.getElementById("6fgolj1club2").innerHTML="";document.getElementById("6fgolj2club2").innerHTML="";document.getElementById("6fNivelclub2").innerHTML="2.541";document.getElementById("6fTecclub2").innerHTML=tec78.nome;
document.getElementById("6fDivclub3").innerHTML="";document.getElementById("6fLogoclub3").innerHTML=logolazio;document.getElementById("6fNomeclub3").innerHTML="Lazio";document.getElementById("6fgolj2club3").innerHTML="";document.getElementById("6fgolj1club3").innerHTML="";document.getElementById("6fNivelclub3").innerHTML="2.608";document.getElementById("6fTecclub3").innerHTML=tec573.nome;document.getElementById("6fDivclub4").innerHTML="";document.getElementById("6fLogoclub4").innerHTML=logointermiami;document.getElementById("6fNomeclub4").innerHTML="Inter Miami";document.getElementById("6fgolj1club4").innerHTML="";document.getElementById("6fgolj2club4").innerHTML="";document.getElementById("6fNivelclub4").innerHTML="2.649";document.getElementById("6fTecclub4").innerHTML=tec479.nome;
document.getElementById("6fDivclub5").innerHTML="";document.getElementById("6fLogoclub5").innerHTML=logojuventusturin;document.getElementById("6fNomeclub5").innerHTML="Juventus";document.getElementById("6fgolj2club5").innerHTML="";document.getElementById("6fgolj1club5").innerHTML="";document.getElementById("6fNivelclub5").innerHTML="2ºCH";document.getElementById("6fTecclub5").innerHTML=tec542.nome;document.getElementById("6fDivclub6").innerHTML="";document.getElementById("6fLogoclub6").innerHTML=logokashimaantlers;document.getElementById("6fNomeclub6").innerHTML="Kashima Antlers";document.getElementById("6fgolj1club6").innerHTML="";document.getElementById("6fgolj2club6").innerHTML="";document.getElementById("6fNivelclub6").innerHTML="2.449";document.getElementById("6fTecclub6").innerHTML=tec574.nome;
document.getElementById("6fDivclub7").innerHTML="";document.getElementById("6fLogoclub7").innerHTML=logoalanly;document.getElementById("6fNomeclub7").innerHTML=" Al Ahly";document.getElementById("6fgolj2club7").innerHTML="";document.getElementById("6fgolj1club7").innerHTML="";document.getElementById("6fNivelclub7").innerHTML="2.484";document.getElementById("6fTecclub7").innerHTML=tec481.nome;document.getElementById("6fDivclub8").innerHTML="";document.getElementById("6fLogoclub8").innerHTML=logoleverkusen;document.getElementById("6fNomeclub8").innerHTML="Leverkusen";document.getElementById("6fgolj1club8").innerHTML="";document.getElementById("6fgolj2club8").innerHTML="";document.getElementById("6fNivelclub8").innerHTML="CDC";document.getElementById("6fTecclub8").innerHTML=tec168.nome;
    ...
    document.getElementById("8fDivclub1").innerHTML="";document.getElementById("8fLogoclub1").innerHTML=logoajax;document.getElementById("8fNomeclub1").innerHTML="Ajax";document.getElementById("8fgolj2club1").innerHTML="";document.getElementById("8fgolj1club1").innerHTML="";document.getElementById("8fNivelclub1").innerHTML="CH";document.getElementById("8fTecclub1").innerHTML=tec539.nome;document.getElementById("8fDivclub2").innerHTML="";document.getElementById("8fLogoclub2").innerHTML="";document.getElementById("8fNomeclub2").innerHTML="vencedor 5";document.getElementById("8fgolj1club2").innerHTML="";document.getElementById("8fgolj2club2").innerHTML="";document.getElementById("8fNivelclub2").innerHTML="";document.getElementById("8fTecclub2").innerHTML="";
    document.getElementById("8fDivclub3").innerHTML="";document.getElementById("8fLogoclub3").innerHTML="";document.getElementById("8fNomeclub3").innerHTML="Campeão Libertadores";document.getElementById("8fgolj2club3").innerHTML="";document.getElementById("8fgolj1club3").innerHTML="";document.getElementById("8fNivelclub3").innerHTML="LB";document.getElementById("8fTecclub3").innerHTML="";document.getElementById("8fDivclub4").innerHTML="";document.getElementById("8fLogoclub4").innerHTML="";document.getElementById("8fNomeclub4").innerHTML="vencedor 6";document.getElementById("8fgolj1club4").innerHTML="";document.getElementById("8fgolj2club4").innerHTML="";document.getElementById("8fNivelclub4").innerHTML="";document.getElementById("8fTecclub4").innerHTML="";
