...
let tottenham=['Tottenham Hotspur',logotottenham,'FALSO','ING','24','2024',,'',,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,'','','','','','','','','','','','','','','','','','','',''];
 ...
 //QUARTAS********************** 
 document.getElementById("7fDivclub1").innerHTML="D";document.getElementById("7fLogoclub1").innerHTML=logoajax;document.getElementById("7fNomeclub1").innerHTML="Ajax Amsterdam";document.getElementById("7fgolj2club1").innerHTML="";document.getElementById("7fgolj1club1").innerHTML="3";document.getElementById("7fNivelclub1").innerHTML="1";document.getElementById("7fTecclub1").innerHTML=tec539.nome;document.getElementById("7fDivclub2").innerHTML="D";document.getElementById("7fLogoclub2").innerHTML=logochelsea;document.getElementById("7fNomeclub2").innerHTML="Chelsea";document.getElementById("7fgolj1club2").innerHTML="4";document.getElementById("7fgolj2club2").innerHTML="";document.getElementById("7fNivelclub2").innerHTML="8";document.getElementById("7fTecclub2").innerHTML=tec544.nome;
 document.getElementById("7fDivclub3").innerHTML="A";document.getElementById("7fLogoclub3").innerHTML=logorealmadrid;document.getElementById("7fNomeclub3").innerHTML="Real Madrid";document.getElementById("7fgolj2club3").innerHTML="";document.getElementById("7fgolj1club3").innerHTML="1";document.getElementById("7fNivelclub3").innerHTML="4";document.getElementById("7fTecclub3").innerHTML=tec534.nome;document.getElementById("7fDivclub4").innerHTML="C";document.getElementById("7fLogoclub4").innerHTML=logoborrusiadortmund;document.getElementById("7fNomeclub4").innerHTML="Borrusia Dortmund";document.getElementById("7fgolj1club4").innerHTML="3";document.getElementById("7fgolj2club4").innerHTML="";document.getElementById("7fNivelclub4").innerHTML="5";document.getElementById("7fTecclub4").innerHTML=tec170.nome;
 document.getElementById("7fDivclub5").innerHTML="B";document.getElementById("7fLogoclub5").innerHTML=logoarsenal;document.getElementById("7fNomeclub5").innerHTML="ArsenaL";document.getElementById("7fgolj2club5").innerHTML="";document.getElementById("7fgolj1club5").innerHTML="2";document.getElementById("7fNivelclub5").innerHTML="3";document.getElementById("7fTecclub5").innerHTML=tec568.nome;document.getElementById("7fDivclub6").innerHTML="B";document.getElementById("7fLogoclub6").innerHTML=logojuventusturin;document.getElementById("7fNomeclub6").innerHTML="Juventus Turin";document.getElementById("7fgolj1club6").innerHTML="4";document.getElementById("7fgolj2club6").innerHTML="";document.getElementById("7fNivelclub6").innerHTML="6";document.getElementById("7fTecclub6").innerHTML=tec542.nome;
 document.getElementById("7fDivclub7").innerHTML="C";document.getElementById("7fLogoclub7").innerHTML=logointermilan;document.getElementById("7fNomeclub7").innerHTML="Inter Milan";document.getElementById("7fgolj2club7").innerHTML="";document.getElementById("7fgolj1club7").innerHTML="3";document.getElementById("7fNivelclub7").innerHTML="2";document.getElementById("7fTecclub7").innerHTML=tec548.nome;document.getElementById("7fDivclub8").innerHTML="A";document.getElementById("7fLogoclub8").innerHTML=logomilan;document.getElementById("7fNomeclub8").innerHTML="Milan AC";document.getElementById("7fgolj1club8").innerHTML="3";document.getElementById("7fgolj2club8").innerHTML="";document.getElementById("7fNivelclub8").innerHTML="7";document.getElementById("7fTecclub8").innerHTML=tec481.nome;
