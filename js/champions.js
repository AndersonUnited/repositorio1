...
let tottenham=['Tottenham Hotspur',logotottenham,'FALSO','ING','24','2024',,'',,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,'','','','','','','','','','','','','','','','','','','',''];
 ...
 //SEMIFINAIS******************
 document.getElementById("8fDivclub1").innerHTML="D";document.getElementById("8fLogoclub1").innerHTML=logoajax;document.getElementById("8fNomeclub1").innerHTML="Ajax Amsterdam";document.getElementById("8fgolj2club1").innerHTML="";document.getElementById("8fgolj1club1").innerHTML="";document.getElementById("8fNivelclub1").innerHTML="1";document.getElementById("8fTecclub1").innerHTML=tec539.nome;document.getElementById("8fDivclub2").innerHTML="C";document.getElementById("8fLogoclub2").innerHTML=logoborrusiadortmund;document.getElementById("8fNomeclub2").innerHTML="Borrusia Dortmund";document.getElementById("8fgolj1club2").innerHTML="";document.getElementById("8fgolj2club2").innerHTML="";document.getElementById("8fNivelclub2").innerHTML="5";document.getElementById("8fTecclub2").innerHTML=tec170.nome;
document.getElementById("8fDivclub3").innerHTML="B";document.getElementById("8fLogoclub3").innerHTML=logojuventusturin;document.getElementById("8fNomeclub3").innerHTML="Juventus Turin";document.getElementById("8fgolj2club3").innerHTML="";document.getElementById("8fgolj1club3").innerHTML="";document.getElementById("8fNivelclub3").innerHTML="6";document.getElementById("8fTecclub3").innerHTML=tec542.nome;document.getElementById("8fDivclub4").innerHTML="A";document.getElementById("8fLogoclub4").innerHTML=logomilan;document.getElementById("8fNomeclub4").innerHTML="Milan AC";document.getElementById("8fgolj1club4").innerHTML="";document.getElementById("8fgolj2club4").innerHTML="";document.getElementById("8fNivelclub4").innerHTML="7";document.getElementById("8fTecclub4").innerHTML=tec481.nome;
